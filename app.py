...
# Configurazione di base obbligatoria come prima istruzione
st.set_page_config(
...
# Router dei moduli con isolamento delle eccezioni
if nav == "1. Macro Intelligence & Fed Liquidity":
    try:
        from pages_modules.page1_macro import render_page1
        render_page1()
    except Exception as e:
        st.error(f"Errore di caricamento Pagina 1: {str(e)}")
    ...
    try:
        ...
        st.error(f"Errore di caricamento Pagina 2: {str(e)}")
